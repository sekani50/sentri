  ...
  useEffect(() => {
    ...
    return (
        <div className="w-full h-full fixed inset-0 text-white bg-[#132D46]">
            ...
            <div ref={iconref} className="w-[190px] inset-0 m-auto justify-center h-20 absolute flex items-center space-x-3">
                <img className="h-full w-full" src={logo} alt="" />
                <div className="text-2xl inline-block">
                    <div className="whitespace-nowrap w-full animation overflow-hidden tracking-[6px]">SENTRI</div>
                </div>
            </div>
