...
const TopNav = () => {
    return (
        <div
        className={`right min-[1024px]:float-right bg-white shadow-lg py-4 px-8 flex justify-between items-center`}>
            ...
            <div className="flex items-center justify-between w-full">
                ...
                <div className="space-x-4 flex items-center">
                    <BsBellFill className="text-[25px] text-gray-300"/>
                    ...
                    <div className="flex items-center space-x-2">
                        <div className="flex flex-col">
                            ...
                            <div className="flex justify-end text-gray-500 w-full text-ellipsis whitespace-nowrap overflow-hidden">Brian johnson</div>
                            </div>
                        <div className="rounded-full h-[40px] w-[40px] bg-[#132D46] "></div>
                        <MdOutlineNavigateNext className="text-[25px] text-[#01C38D] rotate-90"/>

                    </div>

                <div className="bg-[#132D46] space-x-2 rounded-lg w-fit flex p-2 ">
